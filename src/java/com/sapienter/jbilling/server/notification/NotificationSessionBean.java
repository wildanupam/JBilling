    ...
    */
    public Boolean emailInvoice(Integer invoiceId)
        ...
        try {
            ...
            System.out.println("user:"+user.getEntity().getEntity().getId());
            System.out.println("lang:"+user.getEntity().getLanguageIdField());
            System.out.println("invoce:"+invoice.getEntity().getBaseUser()
                    .getUserId());
            ...
            System.out.println("notify msg ended");
